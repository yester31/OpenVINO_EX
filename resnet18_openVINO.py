...
def main():
    ...
    onnx_model_name = "resnet18_cpu.onnx"
    ...
    if not os.path.isfile('model/'+ir_path):
        print("Exporting ONNX model to IR... This may take a few minutes.")
        print(mo_command)
        os.system(mo_command)
    else:
        print(f"IR model {'model/'+ir_path} already exists.")

    ir_path_ = 'model/' + onnx_model_name.split('.')[0]
