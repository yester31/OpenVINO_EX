...
def main():
    ...
    onnx_model_name = "resnet18_{}.onnx".format(device.type)
    ...
    if device.type =='cuda' :
        ...
        sess_options.optimized_model_filepath = "optimized_resnet18_{}.onnx".format(device.type)
    ...
    out = infer(img, ort_session, half)
